...
const CBOR_TYPED_ARRAY = UInt8(64)
const CBOR_TYPED_ARRAY_FLOAT = UInt8(16)
const CBOR_TYPED_ARRAY_SIGNED_INT = UInt8(8)
const CBOR_TYPED_ARRAY_LITTLE_ENDIAN = UInt8(4)

# tags
const CUSTOM_LANGUAGE_TYPE_TAG = 27
const TYPED_ARRAY_TAG_BEGIN = 64
const TYPED_ARRAY_TAG_END = 87
const HOMOGENEOUS_ARRAY_TAG = 41
const MULTIDIM_ARRAY_ROW_MAJOR_TAG = 40
const MULTIDIM_ARRAY_COLUMN_MAJOR_TAG = 1040
